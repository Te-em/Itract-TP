...
public class LocationUtil {
	...
	public static boolean checkPointInBoundingBox(LatLng location, Server selectedServer, int acceptableError){
		...
		return true;
		/*if (location.latitude > selectedServer.getUpperRightLatitude()
			|| location.latitude < selectedServer.getLowerLeftLatitude()
			|| location.longitude > selectedServer.getUpperRightLongitude()
			|| location.longitude < selectedServer.getLowerLeftLongitude())
			return false;
		else return true;*/
		...
		Log.d("test", "lon: " + location.longitude);
		
		Log.d("test", "lower lon: " + selectedServer.getLowerLeftLongitude());
		Log.d("test", "upper lon: " + selectedServer.getUpperRightLongitude());
		...
		Log.d("test", "result l: " + resultLeft[0]);
		Log.d("test", "result r: " + resultRight[0]);
		...
		Log.d("test", "result l+r: " + (resultLeft[0] + resultRight[0]));
		Log.d("test", "result h: " + resultHorizontal[0]);
