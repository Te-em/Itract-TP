...
@Data public class Leg implements Serializable{
    ...
    public void setAgencyTimeZoneOffset(int atzo) { agencyTimeZoneOffset = atzo; }
    ...
    public void setHeadsign(String hs) { headsign = hs; }
    ...
    public void setFrom(Place f) { from = f; }
    ...
    public void setTo(Place t) { to = t; }
    ...
    public void setRouteShortName(String name) { routeShortName = name; }
    ...
    public void setRouteLongName(String name) { routeLongName = name; }
