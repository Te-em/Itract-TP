...
public class Server {
	...
	private String bounds; private Double[] boundsarr;
	...
	public void setBounds2(String[] bounds)
	{
		boundsarr = new Double[bounds.length];
		for(int i = 0; i < bounds.length; i++)
		{
			boundsarr[i] = Double.parseDouble(bounds[i]);
		}
	}
